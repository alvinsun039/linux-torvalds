...
ifneq ($(skipdbg),true)
	...
	# pointing to unstripped version
	find $(pkgdir) \
...
ifeq ($(do_tools_cpupower),true)
	...
	# Override LIB_MIN in order to generate a versioned .so named
...
ifeq ($(do_tools_perf),true)
	...
	cd $(builddirpa)/tools/perf && \
		$(kmake) prefix=/usr HAVE_NO_LIBBFD=1 HAVE_CPLUS_DEMANGLE_SUPPORT=1 CROSS_COMPILE=$(CROSS_COMPILE) \
				NO_LIBPYTHON=1 NO_LIBPERL=1 WERROR=0 BUILD_BPF_SKEL=1
endif
ifeq ($(do_tools_bpftool),true)
