...
.PHONY: printenv updateconfigs insertchanges startnewrelease diffupstream help autoreconstruct finalchecks
...
help:
	...
	@echo
	@echo "  compileselftests : Only compile the selftests listed on linux_selftests variable"
	@echo
	@echo "  runselftests    : Run the selftests listed on linux_selftests variable"
	@echo
...
printenv:
	...
	@echo "linux_selftests  = $(linux_selftests)"
...
diffupstream:
	@git diff-tree -p refs/remotes/linux-2.6/master..HEAD $(shell ls | grep -vE '^($(DEBIAN)|\.git.*)')
...
compileselftests:
	...
	for test in $(linux_selftests); do \
		$(kmake) -C tools/testing/selftests TARGETS="$$test"; \
	done;

runselftests:
	$(kmake) -C tools/testing/selftests TARGETS="$(linux_selftests)" run_tests
