...
static enum mitigation_state spectre_v2_get_cpu_hw_mitigation_state(void)
{
	...
	static const struct midr_range spectre_v2_safe_list[] = {
		...
		MIDR_ALL_VERSIONS(MIDR_FT_1500A),
		MIDR_ALL_VERSIONS(MIDR_FT_2000AHK),
		MIDR_ALL_VERSIONS(MIDR_FT_2000PLUS),
		MIDR_ALL_VERSIONS(MIDR_FT_2000A_4),
		MIDR_ALL_VERSIONS(MIDR_FT_2500),
		{ /* sentinel */ }
	};
