...
/* Copyright (C) 2019 - 2024 Beijing GuangRunTong Corporation. */
...
#if (KERNEL_VERSION(2, 6, 8) > LINUX_VERSION_CODE)
struct msix_entry {
...
#if !defined(HAVE_FREE_NETDEV) && (KERNEL_VERSION(3, 1, 0) > LINUX_VERSION_CODE)
...
/* if we do not have the infrastructure to detect if skb_header is cloned just return false in all cases */
...
/*****************************************************************************/
/* Installations with ethtool version without eeprom, adapter id, or statistics support */
...
#define SLE_VERSION_CODE SLE_VERSION(11, 3, 0)
	...
	#if (SLE_LOCALVERSION(0, 8, 0) > SLE_LOCALVERSION_CODE)
	/* some SLES11sp2 update kernels up to 3.0.101-0.7.x */
	#define SLE_VERSION_CODE SLE_VERSION(11, 2, 0)
	#elif (SLE_LOCALVERSION(63, 0, 0) > SLE_LOCALVERSION_CODE)
...
/* SLES12 GA is 3.12.28-4 kernel updates 3.12.xx-<33 through 52>[.yy] */
#define SLE_VERSION_CODE SLE_VERSION(12, 0, 0)
#elif (KERNEL_VERSION(3, 12, 49) == LINUX_VERSION_CODE)
/* SLES12 SP1 GA is 3.12.49-11 updates 3.12.xx-60.yy where xx={51..} */
...
/*****************************************************************************/
#if (KERNEL_VERSION(2, 4, 5) > LINUX_VERSION_CODE)
...
/*****************************************************************************/
/* 2.4.10 => 2.4.9 */
#if (KERNEL_VERSION(2, 4, 10) > LINUX_VERSION_CODE)
...
#if (KERNEL_VERSION(2, 4, 8) > LINUX_VERSION_CODE)
...
/*****************************************************************************/
/* 2.4.12 => 2.4.10 */
#if (KERNEL_VERSION(2, 4, 12) > LINUX_VERSION_CODE)
...
/*****************************************************************************/
/* 2.4.17 => 2.4.12 */
#if (KERNEL_VERSION(2, 4, 17) > LINUX_VERSION_CODE)
...
/*****************************************************************************/
#if (KERNEL_VERSION(2, 4, 18) > LINUX_VERSION_CODE)
...
/*****************************************************************************/
/* 2.4.23 => 2.4.22 */
#if (KERNEL_VERSION(2, 4, 23) > LINUX_VERSION_CODE)
/*****************************************************************************/
#ifdef NAPI
...
/*****************************************************************************/
/* 2.6.4 => 2.6.0 */
#if (KERNEL_VERSION(2, 4, 25) > LINUX_VERSION_CODE || \
		(KERNEL_VERSION(2, 6, 0) <= LINUX_VERSION_CODE && \
		KERNEL_VERSION(2, 6, 4) > LINUX_VERSION_CODE))
...
/*****************************************************************************/
/* 2.5.71 => 2.4.x */
#if (KERNEL_VERSION(2, 5, 71) > LINUX_VERSION_CODE)
...
#if (KERNEL_VERSION(2, 4, 27) > LINUX_VERSION_CODE || \
		(KERNEL_VERSION(2, 6, 0) <= LINUX_VERSION_CODE && \
		KERNEL_VERSION(2, 6, 5) > LINUX_VERSION_CODE))
...
#if ((KERNEL_VERSION(2, 4, 27) > LINUX_VERSION_CODE) || \
		((KERNEL_VERSION(2, 6, 0) <= LINUX_VERSION_CODE) && \
		(KERNEL_VERSION(2, 6, 3) > LINUX_VERSION_CODE)))
...
/*****************************************************************************/
/* 2.5.28 => 2.4.23 */
#if (KERNEL_VERSION(2, 5, 28) > LINUX_VERSION_CODE)
...
(RHEL_RELEASE_CODE && (RHEL_RELEASE_VERSION(4, 9) < RHEL_RELEASE_CODE)) && \
(RHEL_RELEASE_CODE && (RHEL_RELEASE_VERSION(9, 0) > RHEL_RELEASE_CODE))
...
/*****************************************************************************/
/* 2.6.5 => 2.6.0 */
#if (KERNEL_VERSION(2, 6, 5) > LINUX_VERSION_CODE)
...
/*****************************************************************************/
#if (KERNEL_VERSION(2, 6, 6) > LINUX_VERSION_CODE)
...
/*****************************************************************************/
#if (KERNEL_VERSION(2, 6, 9) > LINUX_VERSION_CODE)
...
#define ADVERTISED_Asym_Pause	BIT(14)
		...
		(RHEL_RELEASE_VERSION(4, 3) < RHEL_RELEASE_CODE) && \
		(RHEL_RELEASE_VERSION(5, 0) > RHEL_RELEASE_CODE)))
#if ((KERNEL_VERSION(2, 6, 9) == LINUX_VERSION_CODE) && !defined(gfp_t))
...
/*****************************************************************************/
#if (KERNEL_VERSION(2, 6, 15) > LINUX_VERSION_CODE)
#ifndef kfree_rcu
...
#endif
static inline unsigned int _kc_compare_ether_addr(const u8 *addr1, const u8 *addr2)
{
...
/*****************************************************************************/
#if (KERNEL_VERSION(2, 6, 17) > LINUX_VERSION_CODE)
#ifndef dev_notice
#define dev_notice(dev, fmt, args...)            \
...
#if (KERNEL_VERSION(2, 5, 0) <= LINUX_VERSION_CODE)
#if (!((RHEL_RELEASE_CODE && \
		((RHEL_RELEASE_VERSION(4, 4) < RHEL_RELEASE_CODE && \
		RHEL_RELEASE_VERSION(5, 0) > RHEL_RELEASE_CODE) || \
		(RHEL_RELEASE_VERSION(5, 0) < RHEL_RELEASE_CODE)))))
...
#if (!(RHEL_RELEASE_CODE && \
		(((RHEL_RELEASE_VERSION(4, 7) <= RHEL_RELEASE_CODE) && \
		(RHEL_RELEASE_VERSION(5, 0) > RHEL_RELEASE_CODE)) || \
		(RHEL_RELEASE_VERSION(5, 6) <= RHEL_RELEASE_CODE))) && \
		!(SLE_VERSION_CODE && SLE_VERSION(10, 2, 0) <= SLE_VERSION_CODE))
...
typedef __u32 __bitwise __wsum;
		...
		(((RHEL_RELEASE_VERSION(4, 7) <= RHEL_RELEASE_CODE) && \
		(RHEL_RELEASE_VERSION(5, 0) > RHEL_RELEASE_CODE)) || \
		(RHEL_RELEASE_VERSION(5, 4) <= RHEL_RELEASE_CODE))) && \
		!(SLE_VERSION_CODE && SLE_VERSION(10, 2, 0) <= SLE_VERSION_CODE))
...
#include <linux/i2c.h>
#if (!(RHEL_RELEASE_CODE && RHEL_RELEASE_VERSION(5, 5) < RHEL_RELEASE_CODE))
...
#if (KERNEL_VERSION(2, 6, 15) <= LINUX_VERSION_CODE)
#if ((KERNEL_VERSION(2, 6, 23) > LINUX_VERSION_CODE) && defined(CONFIG_PM))
#define ANCIENT_PM 1
#elif ((KERNEL_VERSION(2, 6, 23) <= LINUX_VERSION_CODE) && \
			(KERNEL_VERSION(2, 6, 26) > LINUX_VERSION_CODE) && \
...
#if ((RHEL_RELEASE_CODE && RHEL_RELEASE_VERSION(6, 0) <= RHEL_RELEASE_CODE) || \
		(SLE_VERSION_CODE && SLE_VERSION(11, 1, 0) <= SLE_VERSION_CODE))
#if defined(CONFIG_FCOE) || defined(CONFIG_FCOE_MODULE)
...
#if (!(RHEL_RELEASE_CODE && \
		(((RHEL_RELEASE_VERSION(5, 8) <= RHEL_RELEASE_CODE) && \
		(RHEL_RELEASE_VERSION(6, 0) > RHEL_RELEASE_CODE)) || \
		((RHEL_RELEASE_VERSION(6, 1) <= RHEL_RELEASE_CODE) && \
		(RHEL_RELEASE_VERSION(7, 0) > RHEL_RELEASE_CODE)))))
...
#ifndef netdev_name
static const inline char *_kc_netdev_name(const struct net_device *dev)
{
...
#if (!(RHEL_RELEASE_VERSION(5, 7) <= RHEL_RELEASE_CODE) || \
		(RHEL_RELEASE_VERSION(6, 0) == RHEL_RELEASE_CODE))
...
#endif
#endif /* CONFIG_DCB */
#if (RHEL_RELEASE_VERSION(6, 2) <= RHEL_RELEASE_CODE)
#define CONFIG_XPS
					...
					unsigned int base, long *res)
{
	...
	return strict_strtol(buf, base, res);
		...
		RHEL_RELEASE_VERSION(5, 7) > RHEL_RELEASE_CODE))
...
#if (!(RHEL_RELEASE_VERSION(6, 4) <= RHEL_RELEASE_CODE) && \
		!(SLE_VERSION(11, 3, 0) <= SLE_VERSION_CODE))
...
#if (!(RHEL_RELEASE_VERSION(6, 4) <= RHEL_RELEASE_CODE)) && \
		(!(SLE_VERSION(11, 3, 0) <= SLE_VERSION_CODE)) && \
		(KERNEL_VERSION(3, 0, 0) <= LINUX_VERSION_CODE)
...
#if ((RHEL_RELEASE_CODE && RHEL_RELEASE_VERSION(7, 0) >= RHEL_RELEASE_CODE) ||\
		(SLE_VERSION_CODE && SLE_VERSION(12, 1, 0) >= SLE_VERSION_CODE))
...
#if (!(RHEL_RELEASE_CODE && RHEL_RELEASE_VERSION(7, 0) < RHEL_RELEASE_CODE) && \
		!(SLE_VERSION_CODE && SLE_VERSION(10, 4, 0) <= SLE_VERSION_CODE))
...
#define HAVE_SKBUFF_RXHASH
		...
		!(UBUNTU_VERSION_CODE && UBUNTU_VERSION(3, 13, 0, 30) <= UBUNTU_VERSION_CODE))
...
#define devm_kmemdup __kc_devm_kmemdup
		...
		!(SLE_VERSION_CODE && (SLE_VERSION(12, 4, 0) <= SLE_VERSION_CODE)))
...
#if !(RHEL_RELEASE_CODE && RHEL_RELEASE_VERSION(7, 4) <= RHEL_RELEASE_CODE)
...
#if RHEL_RELEASE_CODE && \
	RHEL_RELEASE_VERSION(6, 3) < RHEL_RELEASE_CODE && \
	RHEL_RELEASE_VERSION(7, 3) > RHEL_RELEASE_CODE
...
/*****************************************************************************/
#if (KERNEL_VERSION(3, 18, 4) > LINUX_VERSION_CODE)
#else
...
#endif
#if (!(RHEL_RELEASE_CODE && \
		((RHEL_RELEASE_VERSION(6, 7) <= RHEL_RELEASE_CODE && RHEL_RELEASE_VERSION(7, 0) > RHEL_RELEASE_CODE) || \
		(RHEL_RELEASE_VERSION(7, 2) <= RHEL_RELEASE_CODE))))
...
#if (RHEL_RELEASE_CODE && (RHEL_RELEASE_VERSION(6, 7) < RHEL_RELEASE_CODE) && \
     (RHEL_RELEASE_VERSION(7, 0) > RHEL_RELEASE_CODE))
...
#endif
#if ((RHEL_RELEASE_CODE && (RHEL_RELEASE_VERSION(7, 2) <= RHEL_RELEASE_CODE)) || \
		(SLE_VERSION_CODE && (SLE_VERSION(12, 2, 0) <= SLE_VERSION_CODE)))
...
#endif
#if !((RHEL_RELEASE_VERSION(6, 8) < RHEL_RELEASE_CODE && RHEL_RELEASE_VERSION(7, 0) > RHEL_RELEASE_CODE) && \
		(RHEL_RELEASE_VERSION(7, 2) < RHEL_RELEASE_CODE) && \
...
/*****************************************************************************/
#if (KERNEL_VERSION(4, 1, 9) > LINUX_VERSION_CODE)
#if (!(RHEL_RELEASE_VERSION(7, 2) < RHEL_RELEASE_CODE) && \
		!((SLE_VERSION(11, 3, 0) == SLE_VERSION_CODE) && \
		(SLE_LOCALVERSION(0, 47, 71) <= SLE_LOCALVERSION_CODE)) && \
		!((SLE_VERSION(11, 4, 0) == SLE_VERSION_CODE) && \
		(SLE_LOCALVERSION(65, 0, 0) <= SLE_LOCALVERSION_CODE)) && \
		!(SLE_VERSION(12, 1, 0) <= SLE_VERSION_CODE))
...
static inline unsigned char *skb_checksum_start(const struct sk_buff *skb)
{
	...
	return skb_transport_header(skb);
		...
		UBUNTU_VERSION(4, 4, 0, 21) <= UBUNTU_VERSION_CODE) && \
		!(RHEL_RELEASE_CODE && \
		(RHEL_RELEASE_VERSION(7, 2) < RHEL_RELEASE_CODE)) && \
...
#if !(SLE_VERSION_CODE && (SLE_VERSION(12, 3, 0) <= SLE_VERSION_CODE)) && \
		!(RHEL_RELEASE_CODE && RHEL_RELEASE_VERSION(7, 4) <= RHEL_RELEASE_CODE)
...
#if ((SLE_VERSION(12, 3, 0) <= SLE_VERSION_CODE) ||\
		(RHEL_RELEASE_CODE && RHEL_RELEASE_VERSION(7, 4) <= RHEL_RELEASE_CODE))
#define HAVE_NETIF_TRANS_UPDATE
#endif /* SLES12sp3+ || RHEL7.4+ */
#if ((RHEL_RELEASE_VERSION(7, 3) <= RHEL_RELEASE_CODE) ||\
		(SLE_VERSION(12, 3, 0) <= SLE_VERSION_CODE))
...
#if (SLE_VERSION_CODE && (SLE_VERSION(12, 4, 0) <= SLE_VERSION_CODE))
#define HAVE_PCI_ERROR_HANDLER_RESET_PREPARE
#endif /* SLES >= 12sp4 */
#if (!(RHEL_RELEASE_VERSION(7, 5) <= RHEL_RELEASE_CODE) && \
		!(SLE_VERSION(12, 4, 0) <= SLE_VERSION_CODE))

#if (!defined(KYLIN_KERNEL44))
#define UUID_SIZE 16
typedef struct {
	__u8 b[UUID_SIZE];
} uuid_t;
...
/*****************************************************************************/
#if (KERNEL_VERSION(4, 15, 0) > LINUX_VERSION_CODE)
#if ((RHEL_RELEASE_CODE && (RHEL_RELEASE_VERSION(7, 6) <= RHEL_RELEASE_CODE)) || \
		(SLE_VERSION_CODE && (SLE_VERSION(15, 1, 0) <= SLE_VERSION_CODE)))
...
#if (!(RHEL_RELEASE_VERSION(7, 7) <= RHEL_RELEASE_CODE) && \
		!(SLE_VERSION(12, 4, 0) <= SLE_VERSION_CODE && \
		 SLE_VERSION(15, 0, 0) > SLE_VERSION_CODE) && \
		!(SLE_VERSION(15, 1, 0) <= SLE_VERSION_CODE))
...
#if (SLE_VERSION(15, 1, 0) > SLE_VERSION_CODE)
...
#if (SLE_VERSION_CODE && (SLE_VERSION(15, 1, 0) <= SLE_VERSION_CODE))
#define HAVE_TCF_MIRRED_DEV
#define HAVE_NDO_SELECT_QUEUE_SB_DEV
#define HAVE_TCF_BLOCK_CB_REGISTER_EXTACK
#endif
...
#if (RHEL_RELEASE_CODE && (RHEL_RELEASE_VERSION(8, 1) <= RHEL_RELEASE_CODE))
...
#if (!defined KYLIN_KERNEL)
#if (defined HAVE_SKB_XMIT_MORE) && \
(!(RHEL_RELEASE_CODE && (RHEL_RELEASE_VERSION(8, 2) <= RHEL_RELEASE_CODE)))
...
/*****************************************************************************/
#if (KERNEL_VERSION(5, 4, 0) > LINUX_VERSION_CODE)
#if (SLE_VERSION(15, 2, 0) <= SLE_VERSION_CODE)
...
#if (RHEL_RELEASE_CODE && (RHEL_RELEASE_VERSION(8, 3) <= RHEL_RELEASE_CODE) || \
...
/*****************************************************************************/
#if (KERNEL_VERSION(5, 8, 0) > LINUX_VERSION_CODE)
#if (RHEL_RELEASE_CODE && (RHEL_RELEASE_VERSION(8, 4) <= RHEL_RELEASE_CODE))
/* RHEL >= 8.4 */
...
#define HAVE_TC_FLOW_INDIR_DEV
#endif
#if (SLE_VERSION_CODE && (SLE_VERSION(15, 3, 0) <= SLE_VERSION_CODE))
#define HAVE_TC_FLOW_INDIR_DEV
