...
#define GRTNIC_PARAM(X, desc) \
	static const int X[GRTNIC_MAX_NIC+1] __devinitconst = GRTNIC_PARAM_INIT; \
 ...
 * Default Value: 2
 */
GRTNIC_PARAM(IntMode, "Change Interrupt Mode (0=Legacy, 1=MSI, 2=MSI-X), default 2");
#define GRTNIC_INT_LEGACY		0
#define GRTNIC_INT_MSI			1
#define GRTNIC_INT_MSIX			2

GRTNIC_PARAM(InterruptType, "Change Interrupt Mode (0=Legacy, 1=MSI, 2=MSI-X), default IntMode (deprecated)");
...
GRTNIC_PARAM(InterruptThrottleRate, "Maximum interrupts per second, per vector, (0,1,956-488281), default 1");
