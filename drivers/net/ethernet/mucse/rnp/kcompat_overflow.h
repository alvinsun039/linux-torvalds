 ...
 * #define type_max(T) (T)(is_signed_type(T) ? 
 * 								((T)1 << (8*sizeof(T)-1)) - 1 : ~(T)0)
 *
...
/** check_shl_overflow() - Calculate a left-shifted value and check 
 * overflow
 * 
...
#define check_shl_overflow(a, s, d)                                            \
	({                                                                     \
		...
		typeof(d) _d = d;                                              \
		u64 _a_full = _a;                                              \
		unsigned int _to_shift = _s >= 0 && _s < 8 * sizeof(*d) ? _s : \
									  0;   \
