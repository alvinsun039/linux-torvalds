...
/*
 * Include the definitions file for HAVE/NEED flags for the standard 
 * upstream kernels.
 *
 * Then, based on the distribution we detect, load the distribution 
 * specific definitions file that customizes the definitions for the 
 * target distribution.
 */
