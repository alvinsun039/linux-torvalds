...
#ifndef __NGBE_VF_H__
#define __NGBE_VF_H__
...
struct ngbe_mac_operations {
	s32 (*init_hw)(struct ngbevf_hw *);
	s32 (*reset_hw)(struct ngbevf_hw *);
	s32 (*start_hw)(struct ngbevf_hw *);
	s32 (*clear_hw_cntrs)(struct ngbevf_hw *);
	enum ngbe_media_type (*get_media_type)(struct ngbevf_hw *);
	u32 (*get_supported_physical_layer)(struct ngbevf_hw *);
	s32 (*get_mac_addr)(struct ngbevf_hw *, u8 *);
	s32 (*stop_adapter)(struct ngbevf_hw *);
	s32 (*get_bus_info)(struct ngbevf_hw *);
	s32 (*get_fw_version)(struct ngbevf_hw *);
	s32 (*get_pf_linkstatus)(struct ngbevf_hw *);

	/* Link */
	s32 (*setup_link)(struct ngbevf_hw *, ngbe_link_speed, bool);
	s32 (*check_link)(struct ngbevf_hw *, ngbe_link_speed *, bool *, bool);
	s32 (*get_link_capabilities)(struct ngbevf_hw *, ngbe_link_speed *,
				     bool *);

	/* RAR, Multicast, VLAN */
	s32 (*set_rar)(struct ngbevf_hw *, u32, u8 *, u32, u32);
	s32 (*set_uc_addr)(struct ngbevf_hw *, u32, u8 *);
	s32 (*init_rx_addrs)(struct ngbevf_hw *);
	s32 (*update_mc_addr_list)(struct ngbevf_hw *, u8 *, u32,
				   ngbe_mc_addr_itr, bool);
	s32 (*update_xcast_mode)(struct ngbevf_hw *, int);
	s32 (*get_link_state)(struct ngbevf_hw *hw, bool *link_state);
	s32 (*enable_mc)(struct ngbevf_hw *);
	s32 (*disable_mc)(struct ngbevf_hw *);
	s32 (*clear_vfta)(struct ngbevf_hw *);
	s32 (*set_vfta)(struct ngbevf_hw *, u32, u32, bool, bool);
};
...
struct ngbe_mbx_operations {
	void (*init_params)(struct ngbevf_hw *hw);
	s32  (*read)(struct ngbevf_hw *, u32 *, u16,  u16);
	s32  (*write)(struct ngbevf_hw *, u32 *, u16, u16);
	s32  (*read_posted)(struct ngbevf_hw *, u32 *, u16,  u16);
	s32  (*write_posted)(struct ngbevf_hw *, u32 *, u16, u16);
	s32  (*check_for_msg)(struct ngbevf_hw *, u16);
	s32  (*check_for_ack)(struct ngbevf_hw *, u16);
	s32  (*check_for_rst)(struct ngbevf_hw *, u16);
};
...
struct ngbe_flash_operations {
	s32 (*init_params)(struct ngbevf_hw *);
	s32 (*read_buffer)(struct ngbevf_hw *, u32, u32, u32 *);
	s32 (*write_buffer)(struct ngbevf_hw *, u32, u32, u32 *);
};
...
#define TCALL(hw, func, args...) (((hw)->func != NULL) \
		? (hw)->func((hw), ##args) : -NGBE_ERR_NOSUPP)
...
s32 ngbe_get_fw_version(struct ngbevf_hw *hw);
s32 ngbe_get_pf_link_status(struct ngbevf_hw *hw);
...
s32 ngbe_get_link_state_vf(struct ngbevf_hw *hw, bool *link_state);
