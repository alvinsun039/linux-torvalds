...
#define E56PHY_RXS_IDLE_DETECT_1_IDLE_TH_ADC_PEAK_MAX FORMAT_NOPARENTHERSES(22, 16)
#define E56PHY_RXS_IDLE_DETECT_1_IDLE_TH_ADC_PEAK_MIN FORMAT_NOPARENTHERSES(30, 24)

#define E56PHY_RXS_ANA_OVRDEN_0_ADDR   (E56PHY_RXS_BASE_ADDR+0x08C)
#define E56PHY_RXS_ANA_OVRDEN_0_OVRD_EN_ANA_EN_RTERM_I FORMAT_NOPARENTHERSES(0, 0)
#define E56PHY_RXS_ANA_OVRDEN_0_OVRD_EN_ANA_TRIM_RTERM_I FORMAT_NOPARENTHERSES(1, 1)
#define E56PHY_RXS_ANA_OVRDEN_0_OVRD_EN_ANA_BBCDR_OSC_RANGE_SEL_I FORMAT_NOPARENTHERSES(29, 29)

#define E56PHY_RXS_ANA_OVRDEN_1_ADDR   (E56PHY_RXS_BASE_ADDR+0x090)
#define E56PHY_RXS_ANA_OVRDEN_1_OVRD_EN_ANA_BBCDR_VCOFILT_BYP_I FORMAT_NOPARENTHERSES(0, 0)
#define E56PHY_RXS_ANA_OVRDEN_1_OVRD_EN_ANA_TEST_BBCDR_I FORMAT_NOPARENTHERSES(9, 9)

#define E56PHY_RXS_ANA_OVRDEN_3_ADDR   (E56PHY_RXS_BASE_ADDR+0x098)
#define E56PHY_RXS_ANA_OVRDEN_3_OVRD_EN_ANA_ANABS_CONFIG_I FORMAT_NOPARENTHERSES(15, 15)
#define E56PHY_RXS_ANA_OVRDEN_3_OVRD_EN_ANA_VGA2_BOOST_CSTM_I FORMAT_NOPARENTHERSES(25, 25)
...
#define E56PHY_FETX_FFE_TRAIN_CFG_0_KRT_FETX_INIT_FFE_CFG_2 \
	FORMAT_NOPARENTHERSES(9, 8)
