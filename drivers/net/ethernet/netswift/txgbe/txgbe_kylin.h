#ifndef _TXGBE_KYLIN_H__
#define _TXGBE_KYLIN_H__
...
/*#define TXGBE_SUPPORT_KYLIN_FT*/	/*kylinft to open*/
/*#define TXGBE_SUPPORT_KYLIN_LX*/	/*kylinlx to open*/
...
#ifndef TXGBE_PCIE_RECOVER
#define TXGBE_PCIE_RECOVER 1	/* pcie recovery, defalut to open */
#endif

#ifndef TXGBE_RECOVER_CHECK
#define TXGBE_RECOVER_CHECK 1	/* recover check log , default 1 */
#endif

#ifndef TXGBE_DIS_COMP_TIMEOUT
...
#define adapter_struct txgbe_adapter
#define adapter_q_vector txgbe_q_vector
...
#define CONFIG_TXGBE_DISABLE_PACKET_SPLIT
#endif
...
#undef txgbe_get_netdev_tc_txq
#define txgbe_get_netdev_tc_txq(dev, tc) (&netdev_extended(dev)->qos_data.tc_to_txq[tc])
#endif
/*****************************************************************************/
...
#if ((RHEL_RELEASE_CODE && RHEL_RELEASE_CODE >= RHEL_RELEASE_VERSION(6,11)) ||\
     (SLE_VERSION_CODE && SLE_VERSION_CODE >= SLE_VERSION(11,4,0)))
#define HAVE_NDO_SET_VF_LINK_STATE
#elif (RHEL_RELEASE_CODE && RHEL_RELEASE_CODE > RHEL_RELEASE_VERSION(6,5))
#else
enum {
				    ...
				    int __always_unused budget)
{
	...
	(defined(TXGBE_SUPPORT_KYLIN_FT) || defined(TXGBE_SUPPORT_KYLIN_LX)) )
#if !(SLE_VERSION_CODE && (SLE_VERSION_CODE >= SLE_VERSION(12,3,0))) && \
...
void txgbe_flow_rule_match_basic(const struct flow_rule *rule,
			   struct flow_match_basic *out);
void txgbe_flow_rule_match_control(const struct flow_rule *rule,
			     struct flow_match_control *out);
void txgbe_flow_rule_match_eth_addrs(const struct flow_rule *rule,
			       struct flow_match_eth_addrs *out);
#ifndef HAVE_TC_FLOWER_VLAN_IN_TAGS
void txgbe_flow_rule_match_vlan(const struct flow_rule *rule,
			  struct flow_match_vlan *out);
#endif
void txgbe_flow_rule_match_ipv4_addrs(const struct flow_rule *rule,
				struct flow_match_ipv4_addrs *out);
void txgbe_flow_rule_match_ipv6_addrs(const struct flow_rule *rule,
				struct flow_match_ipv6_addrs *out);
void txgbe_flow_rule_match_ports(const struct flow_rule *rule,
			   struct flow_match_ports *out);
#ifdef HAVE_TC_FLOWER_ENC
void txgbe_flow_rule_match_enc_ports(const struct flow_rule *rule,
			       struct flow_match_ports *out);
void txgbe_flow_rule_match_enc_control(const struct flow_rule *rule,
				 struct flow_match_control *out);
void txgbe_flow_rule_match_enc_ipv4_addrs(const struct flow_rule *rule,
				    struct flow_match_ipv4_addrs *out);
void txgbe_flow_rule_match_enc_ipv6_addrs(const struct flow_rule *rule,
				    struct flow_match_ipv6_addrs *out);
void txgbe_flow_rule_match_enc_keyid(const struct flow_rule *rule,
...
#else /* >=6.1.0*/
#define HAVE_NOT_NAPI_WEIGHT
#endif /* 6.1.0 */

/*****************************************************************************/
#if (LINUX_VERSION_CODE < KERNEL_VERSION(6,2,0))
#else /* >=6.2.0*/
#define HAVE_NOT_PTT_ADJFREQ
#endif /* 6.2.0 */
...
/*****************************************************************************/
#if SLE_VERSION_CODE >= SLE_VERSION(15,5,0)
#undef NEED_NO_NETDEV_PROG_XDP_WARN_ACTION
#define NEED_ETH_HW_ADDR_SET
#endif
