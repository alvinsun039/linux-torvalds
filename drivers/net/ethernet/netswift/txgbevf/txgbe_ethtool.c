...
#ifdef HAVE_ETHTOOL_RING_EXTRA_PRARM
				, struct kernel_ethtool_ringparam *kring,
				  struct netlink_ext_ack *nlack
#endif
...
#ifdef HAVE_ETHTOOL_COALESCE_EXTRA_PRARM
				   ...
				   struct ethtool_rxnfc *cmd)
{
	...
	case TCP_V4_FLOW:
		goto TCP_V4_FLOW_CASE;
	case UDP_V4_FLOW:
		goto UDP_V4_FLOW_CASE;
	case SCTP_V4_FLOW:
	case AH_ESP_V4_FLOW:
	case AH_V4_FLOW:
	case ESP_V4_FLOW:
	case IPV4_FLOW:
		goto IPV4_FLOW_CASE;
	case TCP_V6_FLOW:
		goto TCP_V6_FLOW_CASE;
	case UDP_V6_FLOW:
		goto UDP_V6_FLOW_CASE;
	case SCTP_V6_FLOW:
	case AH_ESP_V6_FLOW:
	case AH_V6_FLOW:
	case ESP_V6_FLOW:
