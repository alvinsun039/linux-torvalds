...
#ifndef _TXGBE_KYLIN_H_
#define _TXGBE_KYLIN_H_
...
#define CONFIG_TGBVF_NAPI
#define NAPI

#define adapter_struct txgbevf_adapter
#define adapter_q_vector txgbevf_q_vector
#define CONFIG_TXGBEVF_MSIX
 ...
 * support Kylin-4.4.58-20170818.kylin.5.desktop-generic*
 * support Kylin-4.4.131-20190815-kvm.kylin.desktop-generic*/
...
#endif
#define SLE_VERSION_CODE SLE_VERSION(CONFIG_SUSE_VERSION, \
		CONFIG_SUSE_PATCHLEVEL, CONFIG_SUSE_AUXRELEASE)
#else
 ...
 * structure. We provide this in txgbevf_kylin.h so that drivers can easily
...
#ifndef HAVE_ETHTOOL_COALESCE_EXTRA_PRARM
#define HAVE_ETHTOOL_COALESCE_EXTRA_PRARM
#endif
...
#if (UBUNTU_VERSION_CODE > UBUNTU_VERSION(5,19,0,0))
#ifdef HAVE_ETHTOOL_COALESCE_EXTRA_PRARM
#undef HAVE_ETHTOOL_COALESCE_EXTRA_PRARM
#endif
#endif /* > 5.19.0.0 */
...
#if (RHEL_RELEASE_CODE > RHEL_RELEASE_VERSION(8,6))
#ifndef HAVE_ETHTOOL_RING_EXTRA_PRARM
#define HAVE_ETHTOOL_RING_EXTRA_PRARM
#endif
#ifndef HAVE_XDP_ACTION_NEW_WARN
#define HAVE_XDP_ACTION_NEW_WARN
#endif

#if (RHEL_RELEASE_CODE == RHEL_RELEASE_VERSION(9,0))
#ifdef HAVE_ETHTOOL_RING_EXTRA_PRARM
#undef HAVE_ETHTOOL_RING_EXTRA_PRARM
#endif
#ifdef HAVE_ETHTOOL_COALESCE_EXTRA_PRARM
#undef HAVE_ETHTOOL_COALESCE_EXTRA_PRARM
#endif
#ifdef HAVE_XDP_ACTION_NEW_WARN
#undef HAVE_XDP_ACTION_NEW_WARN
#endif
#endif /* = 9.0*/
#endif /* > 8.6 */
...
#else /* kernel version <= 5.18.0 */
#endif /* kernel version > 5.18.0 */
