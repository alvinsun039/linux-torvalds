...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	/*=== Customer ID ===*/
	{USB_DEVICE_AND_INTERFACE_INFO(0x3574, 0x5211, 0xff, 0xff, 0xff), .driver_info = RTL8821C}, /* Mandy add for sihaizhonglian 8811cu */
	{USB_DEVICE_AND_INTERFACE_INFO(0x3574, 0x5231, 0xff, 0xff, 0xff), .driver_info = RTL8821C}, /* Mandy add for sihaizhonglian 8821cu */
#endif
