...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDER_ID_REALTEK, 0xC832, 0xff, 0xff, 0xff), .driver_info = RTL8852C},
	{USB_DEVICE_AND_INTERFACE_INFO(0x3574, 0x6251, 0xff, 0xff, 0xff), .driver_info = RTL8852C}, /* Mandy add for sihai dongle 8832cu*/
	{USB_DEVICE_AND_INTERFACE_INFO(0x2357, 0x014d, 0xff, 0xff, 0xff), .driver_info = RTL8852C}, /* Mandy add for tplink dongle 8832cu*/
	{USB_DEVICE_AND_INTERFACE_INFO(0x2357, 0x0150, 0xff, 0xff, 0xff), .driver_info = RTL8852C}, /* Mandy add for tplink dongle 8832cu*/
	{USB_DEVICE_AND_INTERFACE_INFO(0x2357, 0x0151, 0xff, 0xff, 0xff), .driver_info = RTL8852C}, /* Mandy add for tplink dongle 8832cu*/
