...
s32 PHY_MACConfig8192F(PADAPTER Adapter)
{
	...
	/* RESP_SIFS for CCK */
	rtw_write8(padapter, REG_RESP_SIFS_CCK, 0x08); /* SIFS_T2T_CCK (0x08) */
	rtw_write8(padapter, REG_RESP_SIFS_CCK + 1, 0x08); /* SIFS_R2T_CCK(0x08) */
	/* RESP_SIFS for OFDM */
	rtw_write8(padapter, REG_RESP_SIFS_OFDM, 0x0a); /* SIFS_T2T_OFDM (0x0a) */
	rtw_write8(padapter, REG_RESP_SIFS_OFDM + 1, 0x0a); /* SIFS_R2T_OFDM(0x0a) */
#endif
