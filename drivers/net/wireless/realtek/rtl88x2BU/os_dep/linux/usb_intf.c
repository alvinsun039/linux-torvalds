...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE_AND_INTERFACE_INFO(0x3574, 0x5241, 0xff, 0xff, 0xff), .driver_info = RTL8822B}, /* Mandy add for sihai 8812bu dongle */
	{USB_DEVICE_AND_INTERFACE_INFO(0x3574, 0x5261, 0xff, 0xff, 0xff), .driver_info = RTL8822B}, /*  Mandy add for sihai 8822bu dongle*/
