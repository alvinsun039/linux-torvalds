...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE_AND_INTERFACE_INFO(0x3574, 0x6211, 0xff, 0xff, 0xff), .driver_info = RTL8851B}, /* Mandy add for sihaizhonglian 8831bu */
	{USB_DEVICE_AND_INTERFACE_INFO(0x3574, 0x6231, 0xff, 0xff, 0xff), .driver_info = RTL8851B}, /* Mandy add for sihaizhonglian 8851bu */
