...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE_AND_INTERFACE_INFO(0x3574, 0x5251, 0xff, 0xff, 0xff), .driver_info = RTL8822C}, /* Mandy add for sihaizhonglian 8812cu */
	{USB_DEVICE_AND_INTERFACE_INFO(0x2357, 0x0137, 0xff, 0xff, 0xff), .driver_info = RTL8822C}, /* Mandy add for TPLINK 8812cu */
...
static int rtw_drv_init(struct usb_interface *pusb_intf, const struct usb_device_id *pdid)
{
	...
	mark_partner_supported("88x2CU", "Realtek Semiconductor Corp.", THIS_MODULE);
