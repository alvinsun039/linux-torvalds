...
/*********************************************************/
int GB02FUNC1605(const unsigned char *message,
...
/*********************************************************/
int GB02FUNC1627(const unsigned char *message,
                const int message_len,
		const unsigned char *pub_key,
		unsigned char *c1,
		unsigned char *c3,
...
/*********************************************************/
int GB02FUNC1642(const unsigned char *c1,
