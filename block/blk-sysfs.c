...
static ssize_t
queue_unpriv_sgio_show(struct request_queue *q, char *page)
{
	int bit;
...
static ssize_t
queue_unpriv_sgio_store(struct request_queue *q, const char *page, size_t count)
{
	unsigned long val;
	ssize_t ret;
...
QUEUE_RW_ENTRY(queue_unpriv_sgio, "unpriv_sgio");
