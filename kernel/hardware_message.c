 ...
 * had limited testing and is not marked for full support within this KLAS/KLAD
 * minor release. The next KLAS/KLAD minor release may contain full support for
 * this driver. KYLIN does not guarantee that bugs reported against this
